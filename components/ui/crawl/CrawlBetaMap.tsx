...
const CrawlBetaMap: React.FC<CrawlBetaMapProps> = ({ 
  stops, 
  currentStopNumber, 
  completedStops, 
  isNextStopRevealed,
  ...
  try {
    console.log('CrawlBetaMap props:', { stops, currentStopNumber, completedStops, isNextStopRevealed, coordinates });
